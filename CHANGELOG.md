...
- Code structure for improved readability and maintainability
  ([`a729ab8`](https://github.com/domoskanonos/quisy-tts/commit/a729ab8afbd99f33ddf1747b3a2fbb0d5be3a0a4))
...
- Implement audio conversion and enhance SSML processing with new response model
  ([`2657b2d`](https://github.com/domoskanonos/quisy-tts/commit/2657b2d575d3fd9a777f491dda1387a6dba19f9f))

- Implement voice repository and audio service, refactor voice service for better orchestration
  ([`4a53ee6`](https://github.com/domoskanonos/quisy-tts/commit/4a53ee69ebdae55c0ab1f9780862b9da984089c2))

- Remove obsolete files and add architecture documentation
  ([`3bf348b`](https://github.com/domoskanonos/quisy-tts/commit/3bf348b47bd9013126ce347d2ae00c0573716357))

- Deleted output_sound.wav, package-lock.json, package.json, test_write.py, and
...
- Move cache and cleanup services to infrastructure layer and update imports
  ([`39edcd0`](https://github.com/domoskanonos/quisy-tts/commit/39edcd00d6ce48fb99b072be343d7d2d56f2242a))

- Rename TTSEngine to TTSEngineInterface and update related services for consistency
  ([`da16397`](https://github.com/domoskanonos/quisy-tts/commit/da163979faf157b1ba231d30191d447781c75bad))
...
- Rename description field to voice_name in voice schemas and update related database operations
  ([`b6edab6`](https://github.com/domoskanonos/quisy-tts/commit/b6edab639f6678d78e603745463044d0460b32a1))
